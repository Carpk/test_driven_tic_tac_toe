...
describe BoardValues do
  ...
  it "should know when a game is over from a full board" do
    ...
    BoardValues.gameover?(board).should eq(true)
  end
  ...
  it "should know when a game is not over" do
    grid = ["x", "o", " ",
            ...
            "o", "x", " "]
    board = TicTacToeBoard.new(grid)
    BoardValues.gameover?(board).should eq(false)
  end
  ...
  it "should return winner of a winning board" do
    grid = ["x", "o", " ",
            ...
            "x", "x", "x"]
    board = TicTacToeBoard.new(grid)
    BoardValues.winner_of(board).should eq("x")
  end
  ...
  it "should return true if board is tied" do
    grid = ["x", "o", "x",
            ...
            "o", "x", "o"]
    board = TicTacToeBoard.new(grid)
    BoardValues.tie_game?(board).should eq(true)
  end
  ...
  it "should return false if board is not full" do
    grid = ["x", "o", " ",
            ...
            "o", "x", "o"]
    board = TicTacToeBoard.new(grid)
    BoardValues.tie_game?(board).should eq(false)
  end
  ...
  it "should be false if first cell is empty" do
    section = [" ", "g", "g"]
    BoardValues.group_match?(section).should eq(false)
  end
  ...
  it "should be true if argument contains the same character" do
    section = ["g", "g", "g"]
    BoardValues.group_match?(section).should eq(true)
  end
end
